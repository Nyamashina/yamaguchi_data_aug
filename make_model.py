...
if ANNOTATION:
    for i in range(23):
        ...
        for data in annotation:
            with open(os.path.join(out_img_dir, annotation_name + '_{:03}.json'.format(data['frame_id'])), 'w',
                      encoding='utf-8') as f:
...
data_loader = torch.utils.data.DataLoader(frame_dataset, batch_size=2, shuffle=True,collate_fn=collate_fn)
